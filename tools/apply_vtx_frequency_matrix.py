...
end = html.find("function summarizeEngineLoad", fn)
if start < 0 or fn < 0 or end < 0:
    raise SystemExit(f"VTX helper region not found: start={start} fn={fn} end={end}")
...
if render_start < 0 or render_end < 0:
    raise SystemExit(f"VTX render region not found: {render_start}/{render_end}")
